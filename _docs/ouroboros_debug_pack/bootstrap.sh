...
$RUST_COMPILER run "$STAGE1_BIN" --output "$STAGE2_IR"
$RUST_COMPILER build-crate "$STAGE2_IR" --output "$STAGE2_BIN"
...
$RUST_COMPILER run "$STAGE2_BIN" --output "$STAGE3_IR"
$RUST_COMPILER build-crate "$STAGE3_IR" --output "$STAGE3_BIN"
