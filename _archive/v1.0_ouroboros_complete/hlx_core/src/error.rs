...
pub enum HlxError {
    ...
    // === Crate Errors ===
    #[error("E_CRATE_INVALID: Crate integrity check failed")]
    CrateInvalid,

    #[error("E_CRATE_VERSION: Unsupported crate version {version}")]
    CrateVersion { version: u8 },
