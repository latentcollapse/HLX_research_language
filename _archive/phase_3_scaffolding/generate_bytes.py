...
header = b"""// HLX SELF-HOSTED COMPILER (DEBUG)
        ...
        if c == " " or c == "\n" or c == "\t" or c == "\r" {
            ...
            if is_alpha(c) {
                ...
                if is_digit(c) {
                    ...
                    if c == " + lit_quote + b""" + b""" + b"\"" + b""" + b""" {
                        i = i + 1;
                        let s = "";
                        loop (i < len and source[i] != " + lit_quote + b""" + b""" + b"\"" + b""" + b""" , 1000000) {
                            if source[i] == " + lit_backslash + b""" + b""" + b"\"" + b""" + b""" and i + 1 < len and source[i+1] == " + lit_quote + b""" + b""" + b"\"" + b""" + b""" {
                                s = s + " + lit_quote + b""" + b""" + b"\"" + b""" + b""" ;
                                i = i + 2;
                            } else {
                                s = s + source[i];
                                i = i + 1;
...
print("Generated part1_debug.hlxc with BYTE CONSTRUCTION")
