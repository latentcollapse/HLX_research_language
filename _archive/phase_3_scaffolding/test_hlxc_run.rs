...
use hlx_compiler::{hlxc::HlxcParser, parser::Parser, lower::lower_to_crate};
...
fn main() -> anyhow::Result<()> {
    ...
    // 3. Lower to Crate (LC-B)
    println!("[2/3] Lowering to LC-B Crate...");
    let krate = lower_to_crate(&ast)?;
    println!("Crate generated with {} instructions.", krate.instructions.len());
